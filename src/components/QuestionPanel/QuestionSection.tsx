// components/QuestionPanel/QuestionSection.tsx

import styles from "./questionSection.module.css";

interface Props {
  questions: { section: string; questionNo: number; status: string }[];
  selected?: { section: string; questionNo: number };
  ...
  return (
    <div className={styles.buttonGrid}>
      {questions.map((q) => {
        ...
        const classNames = [styles.questionButton, q.status === "reviewed" ? styles.reviewed : "", isSelected ? styles.selected : ""].join(" ");
